  ...
  return (
    <section id='hero' className='flex  flex-col items-center gap-4 relative'>
      ...
      <div className=' relative w-[90%] md:w-[70%] flex flex-row    items-center gap-4 md:h-[592px]   bg-[#EEF5FF] rounded-lg  drop-shadow-[2px_4px_65px_1px_rgba(0, 7, 43, 0.21)]'>
            ...
            <img className="object-fill  w-full h-full" src={heroimage} alt="referimage"></img>
            </div>
            <img  className="hidden lg:block w-[100px] h-[100px] absolute bottom-2 left-[40%] -rotate-45" src={rupee} alt="rupee"></img>
            <img  className="hidden lg:block w-[100px] h-[100px] absolute right-2 top[30%] " src={rupee} alt="rupee"></img>
             <img  className="hidden lg:block w-[100px] h-[100px] absolute left-2 top-2 " src={rupee} alt="rupee"></img> 
